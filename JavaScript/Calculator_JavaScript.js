...
function Input_Decimal(dot) {
    ...
    // doesn't casue bugs in your operation
...
keys.addEventListener('click', (event) => {
    //The target varialbe is an object that represents teh element
    // that was clicked
    const { target } = event;
    ...
    //Ensures that AC clearas the numbers from the calculator 
